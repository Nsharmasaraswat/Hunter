package com.gtpautomation.securityguard.ui.completed_appointments.adapter
...
) : RecyclerView.Adapter<CompletedAppointmentViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CompletedAppointmentViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val listItem: View = layoutInflater.inflate(R.layout.todays_appointment_list_item, parent, false)
        return CompletedAppointmentViewHolder(listItem)
    }
    ...
    override fun onBindViewHolder(holder: CompletedAppointmentViewHolder, position: Int) {
        when(listData[position].status){
            ...
            8 -> {
                ...
                holder.bgGate.setBackgroundColor(context.resources.getColor(R.color.order_completed))
            }
        }
...
class CompletedAppointmentViewHolder(itemView: View) : ViewHolder(itemView) {
