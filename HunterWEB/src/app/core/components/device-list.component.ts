...
export class DeviceListComponent implements OnInit {
    ...
    onDelete() {
        ...
        this.http.delete(environment.coreserver + 'device/' + this.selected.id, { responseType: 'text' })
            .subscribe(msg => {
                if (msg === 'Ok') {
    ...
    onNew() {
        ...
        this.router.navigate(['home/core/device/0']);
    }

    onEdit() {
        // go to create/editing page 
        this.router.navigate(['home/core/device/' + this.selected.id]);
    }
