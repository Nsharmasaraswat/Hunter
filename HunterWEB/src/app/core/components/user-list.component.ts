...
export class UserListComponent implements OnInit {
    ...
    loadData() {
        this.http.get(environment.coreserver + 'user/all')
            .subscribe((msg: any) => {
                console.log(msg);
    ...
    onDelete() {
        ...
        this.http.delete(environment.coreserver + 'user/' + this.selected.id, { responseType: 'text' })
            .subscribe(msg => {
                if (msg === 'Ok') {
    ...
    onNew() {
        ...
        this.router.navigate(['home/core/user/0']);
    }

    onEdit() {
        // go to create/editing page 
        this.router.navigate(['home/core/user/' + this.selected.id]);
    }
