...
export class PermissionListComponent implements OnInit {
    ...
    onDelete() {
        ...
        this.http.delete(environment.coreserver + 'permission/' + this.selected.id, { responseType: 'text' })
            .subscribe(msg => {
                if (msg === 'Ok') {
    ...
    onNew() {
        ...
        this.router.navigate(['home/core/permission/0']);
    }
    ...
    onEdit() {
        // go to create/editing page 
        this.router.navigate(['home/core/permission/' + this.selected.id]);
    }
