...
export class GroupListComponent implements OnInit {
    ...
    onDelete() {
        ...
        this.http.delete(environment.coreserver + 'group/' + this.selected.id, { responseType: 'text' })
            .subscribe(msg => {
                if (msg === 'Ok') {
    ...
    onNew() {
        ...
        this.router.navigate(['home/core/group/0']);
    }
    ...
    onEdit() {
        // go to create/editing page 
        this.router.navigate(['home/core/group/' + this.selected.id]);
    }
