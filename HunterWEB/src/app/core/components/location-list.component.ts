...
export class LocationListComponent implements OnInit {
    ...
    loadData() {
        this.http.get(environment.coreserver + 'location/all')
            .subscribe((msg: any) => {
                this.data = msg.map(s => {
    ...
    onDelete() {
        ...
        this.http.delete(environment.coreserver + 'location/' + this.selected.id, { responseType: 'text' })
            .subscribe(msg => {
                if (msg === 'Ok') {
    ...
    onNew() {
        ...
        this.router.navigate(['home/core/location/0']);
    }
    ...
    onEdit() {
        // go to create/editing page 
        this.router.navigate(['home/core/location/' + this.selected.id]);
    }
