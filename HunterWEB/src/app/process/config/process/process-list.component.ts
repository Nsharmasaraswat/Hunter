...
export class ProcessListComponent implements OnInit {
    ...
    onDelete() {
        ...
        this.http.delete(environment.processserver + 'process/' + this.selected.id, { responseType: 'text' })
            .subscribe(msg => {
                if (msg === 'Ok') {
    ...
    onNew() {
        ...
        this.router.navigate(['home/process/process/0']);
    }

    onEdit() {
        // go to create/editing page 
        this.router.navigate(['home/process/process/' + this.selected.id]);
    }
