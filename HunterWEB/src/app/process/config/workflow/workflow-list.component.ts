...
export class WorkflowListComponent implements OnInit {
    ...
    onDelete() {
        ...
        this.http.delete(environment.processserver + 'workflow/' + this.selected.id, { responseType: 'text' })
            .subscribe(msg => {
                if (msg === 'Ok') {
    ...
    onNew() {
        ...
        this.router.navigate(['home/process/workflow/0']);
    }
    ...
    onEdit() {
        // go to create/editing page 
        this.router.navigate(['home/process/workflow/' + this.selected.id]);
    }
