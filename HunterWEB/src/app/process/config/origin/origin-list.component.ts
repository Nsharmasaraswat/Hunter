...
export class OriginListComponent implements OnInit {
    ...
    onDelete() {
        ...
        this.http.delete(environment.processserver + 'origin/' + this.selected.id, { responseType: 'text' })
            .subscribe(msg => {
                if (msg === 'Ok') {
    ...
    onNew() {
        ...
        this.router.navigate(['home/process/origin/0']);
    }
    ...
    onEdit() {
        // go to create/editing page 
        this.router.navigate(['home/process/origin/' + this.selected.id]);
    }
