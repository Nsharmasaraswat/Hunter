...
public class ProcessActivityRepository extends JPABaseRepository<ProcessActivity, UUID> {
...
//	@Named("ProcessPersistence")
	...
	@Inject
	private Event<ProcessActivity>	paEvent;

	public ProcessActivityRepository() {
		super(ProcessActivity.class, UUID.class);
	}
	...
	@Override
	protected Event<ProcessActivity> getEvent() {
		return paEvent;
	}
