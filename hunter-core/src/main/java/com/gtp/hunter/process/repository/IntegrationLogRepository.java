...
public class IntegrationLogRepository extends JPABaseRepository<IntegrationLog, UUID> {
...
//	@Named("ProcessPersistence")
	...
	@Inject
	private Event<IntegrationLog>	ilEvent;

	public IntegrationLogRepository() {
		super(IntegrationLog.class, UUID.class);
	}
	...
	@Override
	protected Event<IntegrationLog> getEvent() {
		return ilEvent;
	}
