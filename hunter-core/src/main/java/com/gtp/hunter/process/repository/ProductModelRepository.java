...
public class ProductModelRepository extends JPABaseRepository<ProductModel, UUID> {
...
//	@Named("ProcessPersistence")
	...
	@Inject
	private Event<ProductModel>	pmEvent;

	public ProductModelRepository() {
		super(ProductModel.class, UUID.class);
	}
	...
	@Override
	protected Event<ProductModel> getEvent() {
		return pmEvent;
	}
