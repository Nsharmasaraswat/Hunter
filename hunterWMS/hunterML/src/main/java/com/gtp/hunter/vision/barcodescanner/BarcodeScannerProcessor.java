...
package com.gtp.hunter.vision.barcodescanner;
...
public class BarcodeScannerProcessor extends VisionProcessorBase<List<Barcode>> {
    ...
    private OnBarcodeReadListener barcodeReadListener;
...
//                .build();
    ...
    public BarcodeScannerProcessor(Context context, OnBarcodeReadListener barcodeReadListener) {
        super(context);
        // Note that if you know which format of barcode your app is dealing with, detection will be
        // faster to specify the supported barcode formats one by one, e.g.
        BarcodeScannerOptions options = new BarcodeScannerOptions.Builder()
    ...
    protected void onSuccess(
        ...
        for (int i = 0; i < barcodes.size(); ++i) {
            ...
            if (barcodeReadListener != null) barcodeReadListener.process(barcode);
