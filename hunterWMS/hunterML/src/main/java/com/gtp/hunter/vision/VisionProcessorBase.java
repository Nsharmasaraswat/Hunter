...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    private void processImage(ByteBuffer data, final FrameMetadata frameMetadata, final GraphicOverlay graphicOverlay) {
        ...
        requestDetectInImage(InputImage.fromByteBuffer(
                data,
                ...
                graphicOverlay,
                bitmap,
                /* shouldShowFps= */ PreferenceUtils.isFPSEnabled(graphicOverlay.getContext()))
    ...
    public void processImageProxy(@NonNull ImageProxy image, GraphicOverlay graphicOverlay) {
        Preconditions.checkNotNull(image.getImage(), "Image is NULL");
        if (isShutdown) {
            image.close();
            return;
        }
                        ...
                        results -> {
                            ...
                            graphicOverlay.add(
                                    new InferenceInfoGraphic(
                                            graphicOverlay, shouldShowFps, shouldShowFps ? (double) currentLatencyMs : null, shouldShowFps ? framesPerSecond : null));
