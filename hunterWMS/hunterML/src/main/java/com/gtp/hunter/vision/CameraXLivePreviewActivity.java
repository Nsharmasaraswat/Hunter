...
import com.gtp.hunter.vision.automl.AutoMLImageLabelerProcessor;
import com.gtp.hunter.vision.barcodescanner.BarcodeScannerProcessor;
import com.gtp.hunter.vision.facedetector.FaceDetectorProcessor;
import com.gtp.hunter.vision.labeldetector.LabelDetectorProcessor;
import com.gtp.hunter.vision.objectdetector.ObjectDetectorProcessor;
import com.gtp.hunter.vision.preference.PreferenceUtils;
import com.gtp.hunter.vision.preference.SettingsActivity;
import com.gtp.hunter.vision.preference.SettingsActivity.LaunchSource;
import com.gtp.hunter.vision.textdetector.TextRecognitionProcessor;
...
public final class CameraXLivePreviewActivity extends AppCompatActivity
    ...
    private static final String IMAGE_LABELING_TFLITE = "Custom Image Labeling (TFLITE)";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.add(IMAGE_LABELING_TFLITE);
        ...
        try {
            switch (selectedModel) {
                ...
                case IMAGE_LABELING_CUSTOM:
                    ...
                    break;
                case IMAGE_LABELING_TFLITE:
                    Log.i(TAG, "Using Custom Image Label (TFLITE) Detector Processor");
                    AutoMLImageLabelerLocalModel mobilenetModel = new AutoMLImageLabelerLocalModel.Builder()
                            .setAssetFilePath("mobilenet/manifest.json")
                            .build();
                    AutoMLImageLabelerOptions mobilenetOptions = new AutoMLImageLabelerOptions.Builder(mobilenetModel)
                            .setConfidenceThreshold(0.4f)
                            .build();
                    imageProcessor = new AutoMLImageLabelerProcessor(this, mobilenetOptions);
                    break;
                case AUTOML_LABELING:
                    AutoMLImageLabelerLocalModel automlModel = new AutoMLImageLabelerLocalModel.Builder()
                            .setAssetFilePath("automl/manifest.json")
                            .build();
                    AutoMLImageLabelerOptions automlOptions = new AutoMLImageLabelerOptions.Builder(automlModel)
                            .setConfidenceThreshold(0)
                            .build();

                    imageProcessor = new AutoMLImageLabelerProcessor(this, automlOptions);
                    break;
                default:
