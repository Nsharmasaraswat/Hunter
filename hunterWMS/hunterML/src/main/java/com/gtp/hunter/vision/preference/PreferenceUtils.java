...
package com.gtp.hunter.vision.preference;
...
import com.gtp.hunter.vision.CameraSource;
import com.gtp.hunter.vision.R;
...
public class PreferenceUtils {
    ...
    /**
     * Mode type preference is backed by {@link ListPreference} which only support
    ...
    public static boolean isFPSEnabled(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.pref_key_show_fps);
