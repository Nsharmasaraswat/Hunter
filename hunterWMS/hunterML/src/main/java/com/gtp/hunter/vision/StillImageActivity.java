        ...
        try {
            switch (selectedMode) {
                ...
                case AUTOML_LABELING:
                    AutoMLImageLabelerLocalModel automlModel =
                            new AutoMLImageLabelerLocalModel.Builder()
                                    .setAssetFilePath("automl/manifest.json")
                                    .build();
                    AutoMLImageLabelerOptions automlOptions = new AutoMLImageLabelerOptions.Builder(automlModel).setConfidenceThreshold(0).build();
