...
public class InferenceInfoGraphic extends GraphicOverlay.Graphic {
    ...
    public InferenceInfoGraphic(GraphicOverlay overlay, boolean showResolution, @Nullable Double latency, @Nullable Integer framesPerSecond) {
        super(overlay);
    ...
    public synchronized void draw(Canvas canvas) {
        ...
        if (framesPerSecond != null && latency != null) {
