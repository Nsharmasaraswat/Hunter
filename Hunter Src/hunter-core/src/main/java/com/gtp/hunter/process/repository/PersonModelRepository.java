...
public class PersonModelRepository extends JPABaseRepository<PersonModel, UUID> {
...
//	@Named("ProcessPersistence")
	...
	@Inject
	private Event<PersonModel>	pEvent;

	public PersonModelRepository() {
		super(PersonModel.class, UUID.class);
	}
	...
	@Override
	protected Event<PersonModel> getEvent() {
		return pEvent;
	}
