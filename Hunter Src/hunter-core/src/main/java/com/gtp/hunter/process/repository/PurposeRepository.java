...
public class PurposeRepository extends JPABaseRepository<Purpose, UUID> {
...
//	@Named("ProcessPersistence")
	...
	@Inject
	private Event<Purpose>	prEvent;

	public PurposeRepository() {
		super(Purpose.class, UUID.class);
	}
	...
	@Override
	protected Event<Purpose> getEvent() {
		return prEvent;
	}
