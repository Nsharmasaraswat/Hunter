...
public class FilterRepository extends JPABaseRepository<Filter, UUID> {
...
//	@Named("ProcessPersistence")
	...
	@Inject
	private Event<Filter>	fEvent;

	public FilterRepository() {
		super(Filter.class, UUID.class);
	}
	...
	@Override
	protected Event<Filter> getEvent() {
		return fEvent;
	}
