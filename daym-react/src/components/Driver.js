...
class Driver extends Component {
    ...
    checkPermission(permissions){
        return permissions.filter((each)=>each.route === '/driver').length > 0;
    }

    componentDidMount() {
        let permissions = JSON.parse(localStorage.getItem('daym-user')).permissions;
        if(this.checkPermission(permissions)){
            this.setState({methods: permissions.filter((each)=>each.route === '/driver')[0].methods});
        }else {
        ...
        this.userService.getDriverType().then(response =>{
            ...
            // console.log('Driver Data type --->',response);
            ...
            this.userFieldService.getAllFields(userTypeId).then(response => {
                ...
                // console.log('Driver Data field --->',response);
